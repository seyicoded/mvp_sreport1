    ...
    <div class="sidebar-start">
        ...
        <div class="sidebar-body">
            <ul class="sidebar-body-menu">
                ...
                <li>
                    <a href="/admin/newsletter"><span class="icon home" aria-hidden="true"></span>Create Customer</a>
                </li>

                <li>
                    <a href="/admin/newsletter"><span class="icon home" aria-hidden="true"></span>List Customer</a>
                </li>
