    ...
    <div class="sidebar-start">
        <div class="sidebar-head">
            <a href="/" class="logo-wrapper" title="Home">
                ...
                <div class="logo-text">
                    <span class="logo-title">Sample R</span>
                    <span class="logo-subtitle">MVP</span>
                </div>
        ...
        <div class="sidebar-body">
            <ul class="sidebar-body-menu">
                <li>
                    <a class="active" href="/admin"><span class="icon home" aria-hidden="true"></span>New Entry</a>
                </li>

                <li>
                    <a href="/admin/create-customer"><span class="icon home" aria-hidden="true"></span>Create Customer</a>
                </li>

                <li>
                    <a href="/admin/list-customer"><span class="icon home" aria-hidden="true"></span>List Customer</a>
                </li>
