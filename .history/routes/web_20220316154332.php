...
Route::group(['namespace' => 'User'],function () {
    ...
    Route::get('/storage_cc/{file_name}', 'Auth@get_file');
    Route::post('/login_now', 'Auth@login_in');
...
Route::group(['namespace' => 'Admin', 'prefix' => 'admin'], function(){
    ...
    Route::middleware(['admin_auth'])->group(function () {
        ...
        Route::post('/create-customer', 'Home@create_customer');

        // list-customer
        Route::get('/list-customer', function () {
            $dt = DB::select('SELECT * from sample_users', []);
            return view('customer/view')->with('data', $dt);
        });

        // create_new_entry
        Route::post('/create_new_entry', 'Home@create_new_entry');
