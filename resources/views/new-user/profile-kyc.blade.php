                    ...
                    <div class="nk-kycfm">
                            ...
                            <div class="form-group">
                              ...
                              <div class="form-control-group">
                                <input
                                  ...
                                  type="text"
                                  name="fname"
                                  value="{{$investor['data']->first_name}}"
                            ...
                            <div class="form-group">
                              ...
                              <div class="form-control-group">
                                ...
                                required
                                  type="text"
                                  name="dob"
                                  value="{{$investor['data']->dob}}"
                                  placeholder="d-Month-Year"
                                  class="form-control form-control-lg"
                                />
                              </div>
                            </div>
                            ...
                            <div class="form-group">
                              ...
                              <div class="form-control-group">
                                <input
                                  ...
                                  value="{{$investor['data']->telegram_un}}"
                                  class="form-control form-control-lg"
                                />
                              </div>
                            </div>
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <div class="form-control-group">
                                ...
                                required
                                  type="text"
                                  value="{{$investor['data']->nationality}}"
                                  name="nationality"
                                  class="form-control form-control-lg"
                                />
                              </div>
                        ...
                        <div class="nk-kycfm-upload">
                          ...
                          <div class="row align-items-center">
                            ...
                            <div class="col-sm-4 d-none d-sm-block">
                              <div class="mx-md-4">
                                <img
                                  src="https://dashlite.net/demo6/images/icons/id-front.svg"
                                  alt="ID Front"
                                />
                              </div>
                            </div>
                        ...
                        <div class="nk-kycfm-upload">
                          ...
                          <div class="row align-items-center">
                            ...
                            <div class="col-sm-4 d-none d-sm-block">
                              <div class="mx-md-4">
                                <img
                                  src="https://dashlite.net/demo6/images/icons/id-back.svg"
                                  alt="ID Back"
                                />
                              </div>
                            </div>
                      ...
                      <div class="nk-kycfm-footer">
                        ...
                        <div class="nk-kycfm-action pt-2">
                          ...
                          >
                          {{
                              (intval($investor['data']->status) == 0) ? 'Process for Verify':'Process for Update'
                          }}
